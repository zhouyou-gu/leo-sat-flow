...
# texcoords = compute_texcoords(vertices)
# mesh_data = MeshData(vertices=vertices, faces=sphere.mesh_data.get_faces())
# mesh_data.set_texcoords(texcoords)
# sphere.mesh_data = mesh_data

# sphere = SphereVisual(radius=1.0, method='latitude', cols=30, rows=30)

# sphere = scene.visuals.Sphere(radius=10, method='latitude', parent=view.scene, edge_color='black')
# view.add(sphere)

# mesh_data = sphere.mesh.mesh_data
# mesh = scene.visuals.Mesh(meshdata=mesh_data, color="white")
