...
if __name__ == "__main__":
    ...
    for jitter in [0, 10, 20, 30, 40, 50]:
        for angle_spread in [20, 40, 60, 80, 100, 120, 140, 160, 180, 200]:
            ...
            ldl_sg_compare_solver.JITTER = jitter * 1e-6
            for seed in range(N_CONSTELLATION):
                ...
                LOG_CSV_WRITTER.log_mul_scalar("ldl", 0, [jitter, angle_spread, tim, 1., p_o, d_o, p_o_mwm, p_o_random, p_o_grid], g_step=seed)
