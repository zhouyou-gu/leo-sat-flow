...
if __name__ == "__main__":
    ...
    N_SAT = 1000
    for FOR in [30, 45, 60, 75, 90]:
        Time_Varying_Simulation.FOR_THETA_HALF = FOR
        for seed in range(N_CONSTELLATION):
            ...
            for step in range(TEST_STEPS):
                ...
                LOG_CSV_WRITTER.log_mul_scalar("rm_links", step, [FOR, time_step_us_list[step], num_removed, total_links], g_step=seed)
