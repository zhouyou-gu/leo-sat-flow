...
FIG_HEIGHT_PX = 225
DPI = 100
X_LABELS = [r"Starlink", r"Walker-Delta", r"OneWeb"]


apply_plot_style()

current_dir = os.path.dirname(os.path.abspath(__file__))
results_file = latest_augmentation_file("different_constellation_merged.csv")
...
axs.set_position([0.15, 0.13, 0.82, 0.65])
