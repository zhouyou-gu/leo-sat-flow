...
results_file = "/home/zhouyou/leo-sat-flow/sim_alg_v1_res/test_dual_optimization_mixed_constellation/test_dual_optimization_mixed_constellation-2025-July-22-22-44-37-ail/res.csv"

# Plot the data
fig, axs = plt.subplots(1,1)
fig.set_size_inches(fig_width_in, fig_height_in)  # 3.5 inches width, height adjusted to maintain aspect ratio

name = ["Proposed","+Grid","Rand","MRate"]
...
axs.set_ylabel(r"$\sum q^{(s,s')}$ (Gbps)")
