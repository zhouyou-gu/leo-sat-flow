...
results_dir = os.path.join(current_dir, os.path.pardir, "test_dual_optimization_regular_1000_varying_beta")
...
for i, b in enumerate(beta):
    ...
    tmp_dir = "test_dual_optimization_regular_1000_varying_beta-2025-July-16-14-56-44-ail"
...
axs.set_ylabel(r'Total Rates (Gbps)')
...
data_name_list.append(r"Heuristic")
