...
leg = plt.legend(h,l,fontsize=FONT_SIZE, loc='lower left', bbox_to_anchor=(0.05, 0.025, 0.9, 0.3), mode="expand",ncol = 4 ,borderaxespad=0.,handlelength=1, handleheight= 0.8, handletextpad=0.2, 
